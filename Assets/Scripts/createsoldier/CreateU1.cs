...
public class CreateU1 : MonoBehaviour {
    ...
    void CreateKnight(float a, float b)
    {
        ...
        GameObject soldier = (GameObject)Instantiate(Resources.Load("prefabs/UKnight1"));
    ...
    {
        GameObject soldier = (GameObject)Instantiate(Resources.Load("prefabs/UAir1"));
        //make it belongs to 'player1'
        GameObject mUIplay1 = GameObject.Find("player1");
        soldier.transform.parent = mUIplay1.transform;
        //set position 
    ...
    {
        GameObject soldier = (GameObject)Instantiate(Resources.Load("prefabs/UMagic1"));
        //make it belongs to 'player1'
        GameObject mUIplay1 = GameObject.Find("player1");
        soldier.transform.parent = mUIplay1.transform;
        //set position 
    ...
    {
        GameObject soldier = (GameObject)Instantiate(Resources.Load("prefabs/UArcher1"));
        //make it belongs to 'player1'
        GameObject mUIplay1 = GameObject.Find("player1");
        soldier.transform.parent = mUIplay1.transform;
        //set position
