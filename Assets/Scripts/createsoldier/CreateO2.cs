...
public class CreateO2 : MonoBehaviour {
    //this script allows player2 to create Orc

    // level of three barracks
    int[] level = new int[] { 0, 0, 0 };
    // Update is called once per frame
    void Update()
    {
        //barracks can not create soldier if they are destoried
    ...
    {
        GameObject soldier = (GameObject)Instantiate(Resources.Load("prefabs/OKnight2"));
    ...
    {
        GameObject soldier = (GameObject)Instantiate(Resources.Load("prefabs/OArcher2"));
        //make it belongs to 'player2'
        GameObject mUIplay1 = GameObject.Find("player2");
        soldier.transform.parent = mUIplay1.transform;
        //set position
    ...
    {
        GameObject soldier = (GameObject)Instantiate(Resources.Load("prefabs/OAir2"));
        //make it belongs to 'player2'
        GameObject mUIplay1 = GameObject.Find("player2");
        soldier.transform.parent = mUIplay1.transform;
        //set position
    ...
    {
        GameObject soldier = (GameObject)Instantiate(Resources.Load("prefabs/OMagic2"));
        //make it belongs to 'player2'
        GameObject mUIplay1 = GameObject.Find("player2");
        soldier.transform.parent = mUIplay1.transform;
        //set position
